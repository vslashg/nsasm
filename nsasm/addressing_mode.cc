...
std::string ArgsToString(AddressingMode addressing_mode, const Expression& arg1,
  ...
  switch (addressing_mode) {
    ...
    case A_dir_bx: {
      return absl::StrFormat(" %s, X", arg1.ToString());
    }
    case A_dir_by: {
      return absl::StrFormat(" %s, Y", arg1.ToString());
    }
    case A_dir_wx: {
      return absl::StrFormat(" %s, X", arg1.ToString());
    }
    ...
    case A_stk: {
      return absl::StrFormat(" %s, S", arg1.ToString());
    }
    case A_stk_y: {
      return absl::StrFormat(" (%s, S), Y", arg1.ToString());
    }
    case A_mov: {
      return absl::StrFormat(" #%s, #%s", arg1.ToString(), arg2.ToString());
    }
    case A_rel8:
    case A_rel16: {
      return absl::StrFormat(" %s", arg1.ToString());
...
NumericType Arg1Type(AddressingMode a) {
  if (a == A_imm_b || a == A_dir_b || a == A_dir_bx || a == A_dir_by ||
      a == A_ind_b || a == A_ind_bx || a == A_ind_by || a == A_lng_b ||
      a == A_lng_by || a == A_stk || a == A_stk_y || a == A_mov ||
      a == A_rel8) {
    return T_byte;
  }
  if (a == A_imm_w || a == A_dir_w || a == A_dir_wx || a == A_dir_wy ||
      a == A_ind_w || a == A_ind_wx || a == A_lng_w || a == A_rel16) {
    return T_word;
  }
  if (a == A_dir_l || a == A_dir_lx) {
    return T_long;
